...
"1 - Русский язык", ban::first_class_rus, &ban::FIRST_CLASS
};
const ban::MenuItem ban::FIRST_CLASS_LITERATURE = {
"2 - Русская литература", ban::first_class_literature, &ban::FIRST_CLASS
};
const ban::MenuItem ban::FIRST_CLASS_MATH = {
"3 - Математика", ban::first_class_math, &ban::FIRST_CLASS
};
const ban::MenuItem ban::FIRST_CLASS_MATH = {
"3 - Я люблю физкультуру", ban::first_class_physical_culture, &ban::FIRST_CLASS
};
const ban::MenuItem ban::FIRST_CLASS_GO_BACK = {
"0 - Выйти в предыдущее меню", ban::first_class_go_back, &ban::FIRST_CLASS
}; 
...
const int pushkin_size = sizeof(first_class_children)/sizeof(first_class_children[0]);
}

const ban::MenuItem ban::FIRST_CLASS = {
"1 - Изучать предметы 1-го класса", ban::first_class, &ban::CLASS
};
...
"4 - Выйти в главное меню", ban::class_go_back, &ban::CLASS
};
...
const int read_size = sizeof(class_children)/sizeof(class_children[0]);
}

const ban::MenuItem ban::CLASS = {
"1 - Предметы какого класса вы хотите учить?", ban::show_menu, &ban::MAIN, read_children, read_size
};
